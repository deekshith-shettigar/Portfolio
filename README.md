# 🌐 Deekshith Shettigar — Personal Portfolio
...
### 🔐 LockVerse — Full-Stack Password Manager
- AES-256-CBC vault encryption, bcrypt user hashing, zero plain-text storage
...
- **SQL for Data Science** — Great Learning (Aug 2025)
- **Privacy and Security in Online Social Media** — NPTEL · Elite (Jan–Apr 2025)
- **Bash Scripting and Shell Programming** — Infosys Springboard (Feb 2024)
- **Advanced Data Structures & Algorithms in Java** — Infosys Springboard (May 2024)
